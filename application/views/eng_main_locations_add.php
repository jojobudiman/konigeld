                      ...
                      <div class="form-table form-table-with-spacing">
                        <div class="form-row">
                          ...
                          <div class="form-field-content">
                            <input class="form-field-input" type="text" id="bname" placeholder="Business Name">
                          </div>
                        </div>
                      </div>
                      <div class="form-table form-table-with-spacing">
                        <div class="form-row">
                          <label class="form-field-label" for="addrsline1">Address Line 1</label>
                          <div class="form-field-content">
                            <input class="form-field-input" type="text" id="addrsline1" placeholder="Address Line 1">
                          </div>
                        </div>
                        <div class="form-row">
                          <label class="form-field-label" for="addrsline2">Address Line 2</label>
                          <div class="form-field-content">
                            <input class="form-field-input" type="text" id="addrsline2" placeholder="Address Line 2">
                          </div>
                        </div>
                        <div class="form-row">
                          <label class="form-field-label" for="city">City</label>
                          <div class="form-field-content">
                            <input class="form-field-input" type="text" id="city" placeholder="City">
                          </div>
                        </div>
                        <div class="form-row">
                          <label class="form-field-label" for="province">Province</label>
                          <div class="form-field-content">
                        ...
                        <div class="form-row">
                          <label class="form-field-label" for="pcode">Postal Code</label>
                          <div class="form-field-content">
                            <input class="form-field-input" type="text" id="pcode" placeholder="Postal Code">
                          </div>
                      </div>
                    </fieldset>
                    <fieldset class="form-fieldset">
                      <legend class="form-legend">Deactivate Location</legend>
                      <p>Deactivating your current location means you will be unable to receive or recover any of your payment history in this location.</p>
                      <p>
