...
<html lang="en">
  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed">
    ...
    <div class="app-body">
      <main class="dashboard-layout dashboard-layout-content">
        <!-- Breadcrumb-->
        <div class="sidebar">
        ...
        <div class="koni-index-body">
          <div class="animated fadeIn">
              ...
              <div class="fluid-layout static-body">
                ...
                <!--<div class="fluid-box">
                  <div class="konihead">
                    <div class="konihead-heading">
                      <div class="konihead-title">
                        <a href="#">Gross Sales</a>
                      </div>
                    </div>
                    <div class="konihead-body">
                      <div class="konihead-inner">
                        <div class="konihead-text">
                          <div class="konihead-text--body type-prose-line-height konihead-null">
                            <i class="no-transactions"></i>
                ...
                <div class="fluid-box">
                  <div class="konihead">
                    <div class="konihead-heading">
                      <div class="konihead-title">
                        <a href="#">Top Products by Sales</a>
                      </div>
                    </div>
                    <div class="konihead-body">
                      <div class="konihead-inner">
                ...
                <div class="fluid-box">
                  <div class="konihead">
                    <div class="konihead-heading">
                      <div class="konihead-title">
                        <a href="#">Top Categories by Sales</a>
                      </div>
                    </div>
                    <div class="konihead-body">
                      <div class="konihead-inner">
