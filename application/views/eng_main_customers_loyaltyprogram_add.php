                  ...
                  <fieldset class="loyalty-part">
                    <div class="loyalty-part-grid">
                      ...
                      <div class="">
                        <div class="loyalty-part-field">
                          <div class="loyalty-part-field-label">
                            <label for="spend">To gain points</label>
                          </div>
                          <div class="loyalty-part-field-input">
                            <input type="text" id="gainpt" name="">
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="loyalty-part-grid">
                      <div class="">
                        <div class="loyalty-part-field">
                          <div class="loyalty-part-field-label">
                            <label for="spend">Redeem points</label>
                          </div>
                          <div class="loyalty-part-field-input">
                            <input type="text" id="redeempt" name="">
                          </div>
                        </div>
                      </div>
                      <div class="">
                        <div class="loyalty-part-field">
                          <div class="loyalty-part-field-label">
                            <label for="spend">Reward</label>
                          </div>
                          <div class="loyalty-part-field-input">
                            <input type="text" id="rewardpt" name="">
                          </div>
                        </div>
                      </div>
                    </div>
