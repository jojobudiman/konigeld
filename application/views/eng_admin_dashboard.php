              ...
              <div class="col-sm-12 col-lg-4">
                  ...
                  <div class="col-sm-12 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="clearfix">
                                    <i class="fa fa-envelope bg-flat-color-4 p-3 font-2xl mr-3 float-left text-light"></i>
                                ...
                                <hr>
                                <div class="more-info pt-2" style="margin-bottom:-10px;">
                                    <a class="font-weight-bold font-xs btn-block text-muted small" href="<?php echo base_url(). 'admin_messagerequests' ?>">View More <i class="fa fa-angle-right float-right font-lg"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
