            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="<?php echo base_url(). 'english_feature' ?>">Features</a></li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="feature_text_inner">
                            <div class="feature_title">
                                <img src="<?php echo base_url(); ?>assets/img/icon/feature-icon2.png" alt="">
                                <h6 class="f-red">CUSTOMER RELATIONSHIP MANAGEMENT</h6>
                                <h2 class="h1 bold">Kömmunicate</h2>
                            </div>
                            <p>Etiam nec odio vestibulum est mattis effic iturut magna. Pellentesque sit am et tellus blandit. Etiam nec odio vestibul.Cras ex mauris, ornare eget pretium sit amet, dignissim et turpis. Nunc nec maximus dui, vel suscipit dolor. Donec elementum velit a orci facilisis rutrum. Nam convallis vel erat id dictum. Sed ut risus in orci convallis viverra a eget nisi. Aenean pellentesque elit vitae eros dignissim ultrices. </p>
                        </div>
                    </div>
                    <div class="col-lg-6 feature_img">
                        <div class="position-relative">
                            <picture id="feature" class="apropos">
                                <img src="<?php echo base_url(); ?>assets/img/features/kommunicate.png" alt="">
                            </picture>
                        </div>
                    </div>
                </div>
                  ...
                  <div class="col-lg-6 feature_img">
                    ...
                    <div class="col-lg-6 align-right">
                        <div class="feature_text2_inner">
                            <div class="feature_title">
                                <img class="flip-hori" src="<?php echo base_url(); ?>assets/img/icon/feature-icon2.png" alt="">
                                <h6 class="f-red">KÖNIGELD PERMISSIONS</h6>
                    ...
                    <div class="grid grid-space-base">
                        <div class="column">
                            <div class="display-inline-block">
                                <a class="button gap-none" href="">TRY FOR FREE</a>
                            </div>
                        </div>
                    </div>
                </div>
