                ...
                <header class="dialog-header">
                  <div class="dialog-header-content">
                    <div class="dialog-header-part">
                      <button type="button" onclick="location.href='<?php echo base_url(). 'modifiers'?>'">
                    ...
                    <h2 class="dialog-header-title">Change Subscription Plan</h2>
                    <div class="dialog-primary-actions">
                      <form id="change-subscriptions" action="<?php echo base_url(). 'subscriptions_change/exact' ?>" method="post">
                  ...
                  <div class="dialog-content">
                    <div class="row">
                      <div class="pricing-group">
                        <div class="price-entry entry">

                        </div>
                      </div>
                      <div class="pricing-group">
                        <div class="price-junior junior">

                        </div>
                      </div>
                      <div class="pricing-group">
                        <div class="pricing-senior senior">
