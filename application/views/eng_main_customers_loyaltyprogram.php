      ...
      <div class="animated fadeIn">
        <main class="dashboard-layout">
          ...
          <div class="dashboard-header-layout-sidebar dashboard-header-layout-sidebar-nav">
            <a href="<?php echo base_url(). 'customers' ?>" class="dashboard-header-sidebar-link">Directory</a>
            <a href="<?php echo base_url(). 'customersprogram' ?>" class="dashboard-header-sidebar-link dashboard-header-sidebar-link--active">Loyalty Program</a>
          </div>
          <!--End Sidebar-->
          <!--Container-->
            ...
            <div class="page-layout product-library-parent">
              <div class="product-categories-header">
                ...
                <div class="product-categories-button">
                  <button class="konibutton button-primary" type="button" onclick="location.href='<?php echo base_url(). 'customersprogram_edit' ?>'">Edit Program</button>
                </div>
              </div>
