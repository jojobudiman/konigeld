    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(). 'admin' ?> "><img src="<?php echo base_url(); ?>assets/admin/images/logo.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="<?php echo base_url(). 'admin' ?>"><img src="<?php echo base_url(); ?>assets/admin/images/logo2.png" alt="Logo"></a>
            </div>
