              ...
              <div class="crud-layout-active dialog">
                <header class="dialog-header">
                  <div class="dialog-header-content">
                    ...
                    <form id="add-employee" action="<?php echo base_url(). 'employees/add' ?>" method="post">
                          ...
                          <div class="form-table">
                            ...
                            <div class="form-row">
                              <div class="form-field">
                                ...
                                <div class="form-field-content">
                                  <select class="select-down" placeholder="Select Role">
                                    <option value="1">Meister</option>
                          ...
                          <div class="form-table">
                            <div class="form-row">
                              <div class="form-field form-field-with-checkboxes">
                                ...
                                <div class="form-field-content">
                                  <label class="form-checkbox" for="all-locations">
                                  ...
                                  <label class="form-checkbox" for="lokasi1">
                                  ...
                                  <label class="form-checkbox" for="lokasi2">
