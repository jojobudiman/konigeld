              ...
              <div class="crud-layout-active dialog">
                <header class="dialog-header">
                  <div class="dialog-header-content">
                    ...
                    <h2 class="dialog-header-title">Add Employee</h2>
                    <form id="add-employee" action="<?php echo base_url(). 'employees_new/add' ?>" method="post">
                            ...
                            <div class="form-row">
                              <div class="form-field">
                                ...
                                <div class="form-field-content">
                                  <input class="form-field-input" type="text" id="fname" name="fname" placeholder="First Name">
                                </div>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-field">
                                ...
                                <div class="form-field-content">
                                  <input class="form-field-input" type="text" id="lname" name="lname" placeholder="Last Name">
                                </div>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-field">
                                ...
                                <div class="form-field-content">
                                  <input class="form-field-input" type="text" id="phone" name="phone" placeholder="Phone Number">
                                </div>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-field">
                                ...
                                <div class="form-field-content">
                                  <input class="form-field-input" type="email" name="email" placeholder="Email">
                                </div>
                              </div>
                            </div>
                              <div class="form-row">
                              <div class="form-field">
                                <label class="form-field-label" for="">Password</label>
                                <div class="form-field-content">
                                  <input class="form-field-input" type="password" name="pass" placeholder="Password">
                                </div>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-field">
                                ...
                                <div class="form-field-content">
                                  <div class="form-field-arrow-container">
                                      <input class="form-field-input" type="text" name="role" placeholder="Role">
                                  </div>
                                </div>
                              </div>
                            </div>
                              ...
                              <div class="form-field form-field-with-checkboxes">
                                ...
                                <div class="form-field-content">
                                  <select name="loc" class="form-field-select">
                                      ...
                                      <option value="<?php echo $list->id_outlet ?>"><?php echo $list->alamat_outlet ?></option>
                                      <?php } ?>
                                    </select>
                                </div>
                              </div>
