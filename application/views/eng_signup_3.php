            ...
            <div class="grid-2-at-medium">
              ...
              <div class="pad-top-small">
                <div class="grid-1-at-medium">
                  <div class="column">
                    ...
                    <div class="input-element">
                      <input type="text" name="phonenum" id="phonenum" placeholder="Enter phone number" maxlength="12">
                    </div>
                  </div>
                </div>
              </div>
              <div class="pad-top-small">
                <div class="grid-2-at-medium">
                  <div class="column select-field">
                    <div class="field-label">
                      <label for="startyear">In what year did you first start your business?</label>
                    </div>
                    <div class="input-element">
                      <div class="select">
                        <select id="startyear" name="startyear" value="Select Year..">
                  ...
                  <div class="column select-field">
                    <div class="field-label">
                      <label for="btype">What type of business is it?</label>
                    </div>
                    <div class="input-element">
                      <div class="select">
                        <select id="btype" name="btype" value="Select Type..">
                          <option value disabled>Select Type..</option>
                          <option value="coffee_shop">Coffee Shop</option>
                          <option value="restaurant">Restaurant</option>
                          <option value="services">Services</option>
                          <option value="mini_booths">Mini Booths</option>
              ...
              <div class="pad-top-small">
                <div class="grid-2-at-medium">
                  <div class="column select-field">
                    <div class="field-label">
                      <label for="monthlyrevenue">What is your estimated monthly revenue?</label>
                    </div>
                    <div class="input-element">
                      <div class="select">
                        <select id="monthlyrevenue" name="monthlyrevenue" value="Select Estimated Revenue..">
                          <option value disabled>Select Estimated Revenue..</option>
                          <option value="less_300">Less than Rp 300.000</option>
                          <option value="300_500">Rp 300.001 - Rp 500.000</option>
                          <option value="500_750">Rp 500.001 - Rp 750.000</option>
                          <option value="750_1000">Rp 750.001 - Rp 1.000.000</option>
                          <option value="1000_1500">Rp 1.000.001 - Rp 1.500.000</option>
                          <option value="1500_3000">Rp 1.500.001 - Rp 3.000.000</option>
                          <option value="more_3000">More than Rp 3.000.000</option>
                        </select>
                        <i></i>
                      </div>
                    </div>
                  ...
                  <div class="column select-field">
                    <div class="field-label">
                      <label for="blocation">Where is your business located?</label>
                    </div>
                    <div class="input-element">
                      <div class="select">
                        <select id="blocation" name="blocation" value="Select Location..">
                          ...
                          <option value="TGS">Tangerang Selatan</option>
                        </select>
                        <i></i>
                      </div>
                    </div>
