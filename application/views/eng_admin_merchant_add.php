                    ...
                    <div class="col-md-12">
                      <div class="card">
                                                  <div class="card-header">
                                                      <strong>Merchant Table</strong> - Add Element
                                                  </div>
                                                  <div class="card-body card-block">
                                                      <form name="add-merchant" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                          ...
                                                          <div class="row form-group">
                                                              ...
                                                              <div class="col-12 col-md-9"><textarea name="location-business" id="location-business" rows="9" placeholder="Enter Location" class="form-control"></textarea></div>
                                                          </div>
                                                          <div class="row form-group">
                                                          ...
                                                          <div class="row form-group">
                                                              ...
                                                              <div class="col-12 col-md-9"><input type="number" id="start-year" name="start-year" placeholder="Enter Starting Year" class="form-control"></div>
                                                          </div>
                                                           <div class="row form-group">
