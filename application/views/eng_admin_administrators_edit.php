                                                  ...
                                                  <div class="card-body card-block">
                                                      <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                          ...
                                                          <div class="row form-group">
                                                              ...
                                                              <div class="col-12 col-md-9"><input type="text" id="fname-admin" name="fname-admin" placeholder="First Name" value="" class="form-control"></div>
                                                          </div>
                                                          <div class="row form-group">
                                                              <div class="col col-md-3"><label for="lname-admin" class=" form-control-label">Last Name</label></div>
                                                              <div class="col-12 col-md-9"><input type="text" id="lname-admin" name="lname-admin" placeholder="Last Name" value="" class="form-control"></div>
                                                          </div>
                                                          <div class="row form-group">
                                                              <div class="col col-md-3"><label for="email-admin" class=" form-control-label">Email</label></div>
                                                              <div class="col-12 col-md-9"><input type="email" id="email-admin" name="email-admin" placeholder="Enter Email" value="" class="form-control"></div>
                                                          </div>
                                                          <div class="row form-group">
                                                              <div class="col col-md-3"><label for="pass-admin" class=" form-control-label">Password</label></div>
                                                              <div class="col-12 col-md-9"><input type="password" id="pass-admin" name="pass-admin" placeholder="Password" value="" class="form-control"></div>
                                                          </div>
                                                          <div class="row form-group">
