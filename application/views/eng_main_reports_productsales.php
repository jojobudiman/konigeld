        ...
        <main class="dashboard-layout">
          ...
          <div class="dashboard-header-layout-sidebar dashboard-header-layout-sidebar-nav">
            ...
            <div class="dashboard-header-sidebar-parent-children" style="height: 320px;">
              ...
              <a href="<?php echo base_url(). 'reports_productsales'?>" class="dashboard-header-sidebar-link dashboard-header-sidebar-link-child dashboard-header-sidebar-link--active">Product Sales</a>
