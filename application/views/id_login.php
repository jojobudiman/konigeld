      ...
      <nav role="navigation" class="konibanner">
        <div class="content">
          ...
          <div class="column flex-align-center">
            <a href="<?php echo base_url(). 'bahasa_home'?>" class="logo">
              ...
              <div id="logincontainer">
                <div class="align-left-medium">
                  ...
                  <div style="margin-top: 30px;">
                    <h2 class="title super-strong text-center">Bahasa Indonesia Segera Muncul</h2>
                    <h5 class="text-center">Kami mohon maaf karena untuk memasuki Königeld, bahasa tersebut belum dapat dikembangkan.<br>Anda dapat mengklik logo tersebut untuk kembali ke perjalanan anda.</h5>
                  </div>
                </div>
                </div>
