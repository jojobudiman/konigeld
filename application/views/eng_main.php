        ...
        <header class="main_menu_area">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <li class="nav-item active"><a class="nav-link" href="<?php echo base_url(). 'english_home' ?>">Home</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="<?php echo base_url(). 'english_pricing' ?>">Pricing</a></li>
            ...
            <div class="content">
                <div class="intro">
                    <div class="font-size-large align-center">
                        <h2 class="balance-text h2" style="">Built for simplicity, and trusted by more<br data-owner="balance-text">than 1000 businesses globally.</h2><p>Set up your Königeld Point of Sale system with ease. The intuitive order and payment flow makes POS transactions a snap and let you effortlessly manage customers and your entire business.</p>
                        ...
                        <div class="grid-2-at-medium grid-valign-middle">
                            ...
                            <div class="column align-left content-cell-padding-left">
                                <div class="general-1">
                                    ...
                                    <p>Adjust your owned products by add different features such as SKUs, and stocks dynamically.</p>
                                </div>
                            </div>
                        </div>
                    </div>
