      ...
      <div class="animated fadeIn">
        <main class="dashboard-layout">
          ...
          <div class="dashboard-header-layout-sidebar dashboard-header-layout-sidebar-nav">
            <a href="#" class="dashboard-header-sidebar-link dashboard-header-sidebar-link--active">Directory</a>
            <a href="#" class="dashboard-header-sidebar-link">Loyalty Program</a>
          </div>
          <!--End Sidebar-->
          <!--Container-->
                    ...
                    <div class="filter-bar">
                      ...
                      <div class="filter-bar-actions">
                        <div class="filter-bar-item">
                          <button class="konibutton button-primary filter-bar-item" type="button" data-href="<?php echo base_url();?>customers_new">Add Customer</button>
                        </div>
                      </div>
                    </div>
