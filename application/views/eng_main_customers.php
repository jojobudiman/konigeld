      ...
      <div class="animated fadeIn">
        <main class="dashboard-layout">
          ...
          <div class="dashboard-header-layout-sidebar dashboard-header-layout-sidebar-nav">
            <a href="<?php echo base_url(). 'customers' ?>" class="dashboard-header-sidebar-link dashboard-header-sidebar-link--active">Directory</a>
            <a href="<?php echo base_url(). 'customersprogram' ?>" class="dashboard-header-sidebar-link">Loyalty Program</a>
          </div>
          <!--End Sidebar-->
          <!--Container-->
                    ...
                    <div class="filter-bar">
                      ...
                      <div class="filter-bar-actions">
                        <div class="filter-bar-item">
                          <button class="konibutton button-primary filter-bar-item" type="button" onclick="location.href='<?php echo base_url(). 'customers_new' ?>'">Add Customer</button>
                        </div>
                      </div>
                    </div>
                              ...
                              <thead>
                                <tr>
                                  <th colspan="1" rowspan="1" class="item-table-name super-strong">
                                    <div class="table-name-column arrow-up"><a class="customer-list-header" href="#">Name</a></div>
                                  </th>
                                  <th colspan="1" rowspan="1" class="item-table-name-2 super-strong">
                                    <div class="table-name-column">Phone</div>
                                  </th>
                                    <th colspan="1" rowspan="1" class="item-table-name-2 super-strong">
                                      <div class="table-name-column">Email</div>
                                    </th>
                                </tr>
                              </thead>
                              <tbody>
