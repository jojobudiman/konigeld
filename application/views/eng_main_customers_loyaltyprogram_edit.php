              ...
              <div class="crud-layout-active dialog">
                <header class="dialog-header">
                  <div class="dialog-header-content">
                    ...
                    <h2 class="dialog-header-title">Edit Loyalty Program</h2>
                    <div class="dialog-primary-actions">
                      <div class="dialog-primary-actions-primary">
                        <button class="konibutton button-secondary" onclick="location.href='<?php echo base_url(). 'customersprogram/delete' ?>'">
                          <span class="button-label">Delete</span>
                        </button>
                      </div>
                      <form id="edit-loyaltyprogram" action="<?php echo base_url() . 'customersprogram/update' ?>">
                      <div class="dialog-primary-actions-primary">
                ...
                <div class="program-container">
                    <h3 class="program-title">Choose your loyalty program type</h3>
                  <div class="selectkonibox">
                    <div class="selectkonibox-inner">
                      <div class="selectkonibox-inner-logo">
                        <svg version="1.1" width="200" height="150" id="loyaltyprogram" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                      ...
                      <div class="selectkonibox-inner-text">
                        <h1 class="super-strong">Cashback</h1>
                        <p>Customers gain points for a certain percentage amount of money they spend in each transaction.</p>
                      </div>
                    </div>
                  </div>
                  <fieldset class="loyalty-part">
                    <div class="loyalty-part-grid">
                      <div class="">
                        <div class="loyalty-part-field">
                          <div class="loyalty-part-field-label">
                            <label for="spend">Spend</label>
                          </div>
                          <div class="loyalty-part-field-input">
                            <input type="text" id="spendpt" name="">
                          </div>
                        </div>
                      </div>
                      <div class="">
                        <div class="loyalty-part-field">
                          <div class="loyalty-part-field-label">
                            <label for="gainpt">To gain points</label>
                          </div>
                          <div class="loyalty-part-field-input">
                            <input type="text" id="gainpt" value="" name="">
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="loyalty-part-grid">
                      <div class="">
                        <div class="loyalty-part-field">
                          <div class="loyalty-part-field-label">
                            <label for="redeempt">Redeem points</label>
                          </div>
                          <div class="loyalty-part-field-input">
                            <input type="text" id="redeempt" value="" name="">
                          </div>
                        </div>
                      </div>
                      <div class="">
                        <div class="loyalty-part-field">
                          <div class="loyalty-part-field-label">
                            <label for="rewardpt">Reward</label>
                          </div>
                          <div class="loyalty-part-field-input">
                            <input type="text" id="rewardpt" value="" name="">
                          </div>
                        </div>
                      </div>
                    </div>
