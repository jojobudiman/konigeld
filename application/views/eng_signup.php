      ...
      <div class="content pad-vert-small pad-horz-medium-at-large content-width-large pad-vert-medium-at-medium">
        <div id="createAcc">
          <div class="align-center-at-medium">
            <h3 class="title super-strong">Let's create your account!</h3>
            <p class="p-description">Signing up for Königeld account is fast and free — no commitments or long-term contracts.</p>
          </div>
          <fieldset class="pad-vert-small t-value-props">
            <div class="grid-3-at-medium grid-row-space-line align-center-at-medium active-section">
              <div class="column fadeIn">
                <div class="grid-flex display-block-at-medium grid-row-space-base">
                  <div class="column no-shrink">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 53.43 43.041">
                  ...
                  <div class="column expand">
                    <h6 class="super-strong">Learn the basics</h6>
              ...
              <div class="column fadeIn">
                <div class="grid-flex display-block-at-medium grid-row-space-base">
                  <div class="column no-shrink">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 52.954 52.673">
                  ...
                  <div class="column expand">
                    <h6 class="super-strong">Free guidebook</h6>
                    <p>Once you register, you’ll get the Königeld Guidebook to improve your business.</p>
                  </div>
                </div>
              </div>
              <div class="column fadeIn">
                <div class="grid-flex display-block-at-medium grid-row-space-base">
                  <div class="column no-shrink">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 42.142 44.421">
                  ...
                  <div class="column expand">
                    <h6 class="super-strong">14 day free trial</h6>
                    <p>When you’re done, you’ll receive a 14 day free trial in Königeld. Be a jack of sales!</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <form id="signup" class="" action="<?php echo base_url().'signup/cont' ?>" method="post">
            <fieldset class="border-top pad-top-small">
              ...
              <div class="grid-2-at-medium grid-row-space-line pad-top-line">
                <div class="column">
              ...
              <div class="border-top gap-top-small pad-top-small">
                <div class="grid-2-at-medium grid-align-center">
                  <div class="column">
                    <div class="column align-center">
                      <p id="login">Already have a Königeld account? <a href="<?php echo base_url(). 'login'?>">Login.</a></p>
                    </div>
                  </div>
                  <div class="column">
