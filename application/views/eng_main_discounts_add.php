                                ...
                                <div class="form-field-content">
                                  <div class="form-field-percent-or-amount">
                                    <div class="form-field-with-segmented-control-input">
                                      <input class="form-field-input money-text" type="text" placeholder="Rp 0.00">
                                      <!--<input class="form-field-input percent-text" type="text" placeholder="%">-->
                                    </div>
                                    <div class="form-field-with-segmented-controls segmented-control">
                                      <button class="konibutton segmented-control-segment form-field-with-segmented-control-segment" type="button">%</button>
                                      <button class="konibutton segmented-control-segment form-field-with-segmented-control-segment" type="button">Rp</button>
                                    </div>
                                  </div>
                                </div>
                              </div>
