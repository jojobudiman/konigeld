              ...
              <div class="crud-layout dialog">
                <header class="dialog-header">
                  <div class="dialog-header-content">
                    ...
                    <h2 class="dialog-header-title">Create Product</h2>
                    <div class="dialog-primary-actions">
                      <div class="dialog-priimary-actions-primary">
                ...
                <div class="dialog-body">
                  <div class="dialog-content">
                    <fieldset class="form-fieldset">
                      ...
                      <div class="grid-row">
                        <div class="grid-col grid-col-19-24">
                          <div class="form-table">
                            ...
                            <div class="form-row">
                              <div class="form-field">
                                ...
                                <div class="form-field-content">
                                  <select class="select-down" placeholder="Select Category">
