      ...
      <div class="animated fadeIn">
        <main class="dashboard-layout">
          ...
          <div class="dashboard-header-layout-sidebar dashboard-header-layout-sidebar-nav">
            <a href="#" class="dashboard-header-sidebar-link dashboard-header-sidebar-link--active">Personal Information</a>
                ...
                <div class="accountsettings-layout">
                  <div class="accountsettings-layout-content">
                    ...
                    <fieldset class="form-fieldset accountsettings-layout-content-fieldset">
                      ...
                      <p>
                        <button class="konibutton button-secondary-desct" type="button">Deactivate Account</button>
                      </p>
                    </fieldset>
                  </div>
                </div>
              </div>
              <nav class="navbar-toolbar page-toolbar">
                <ul class="float-right">
                  <li class="float-left">
                    <button class="konibutton button-secondary" type="button">
