                ...
                <header class="dialog-header">
                  <div class="dialog-header-content">
                    <div class="dialog-header-part">
                      <button type="button" onclick="location.href='<?php echo base_url(). 'employees_permissions'?>'">
                    ...
                    <h2 class="dialog-header-title">Employee Point of Sale Access</h2>
                    ...
                    <fieldset class="form-fieldset">
                      <legend class="form-legend">Permissions</legend>
                        <h5 class="form-helptext form-helptext-intro">
                          Any actions selected below can be performed by employees using Point of Sale. Any unselected actions will require an authorized employee’s passcode to be entered before they can be performed.
                        </h5>
                        <div class="form-table">
                          <div class="form-row">
                            <div class="form-field form-field-with-checkboxes">
                              <label class="form-field-label" for="">Permissions</label>
                                <div class="form-field-content">
                                  <label class="form-checkbox-perm" for="anfanger">
                                    <input class="form-checkbox-input" id="anfanger" type="checkbox">
                                    <div class="form-checkbox-label">
                                      <div class="form-checkbox-label-text">
                                        <div class="form-permission-text super-strong">
                                          Anfänger - Access Application
                                        </div>
                                        <div class="form-helptext-desc">
                                          Allow your employees to access these selected permissions on mobile apps. Use these features below to manage those permissions.
                                        </div>
                                      </div>
                                    </div>
                                  </label>
                              ...
                              <div class="form-field form-field-with-checkboxes konicursor">
                                <label class="form-field-label konicursor" for=""></label>
                                <div class="form-field-content">
                                  <label class="form-checkbox konicursor">
                                    <input class="form-checkbox-input konihide konicursor" type="checkbox">
                                    <div class="form-checkbox-label konicursor">
                                      <div class="form-checkbox-label-text">Apply Restricited Discounts</div>
                                    </div>
                                  </label>
                                  <label class="form-checkbox konicursor">
                                    <input class="form-checkbox-input konihide konicursor" type="checkbox">
                                    <div class="form-checkbox-label konicursor">
                                      <div class="form-checkbox-label-text">Cancel Transactions</div>
                                    </div>
                                  </label>
                                  <label class="form-checkbox konicursor">
                                    <input class="form-checkbox-input konihide konicursor" type="checkbox">
                                    <div class="form-checkbox-label konicursor">
                                      <div class="form-checkbox-label-text">Change Settings: Receipts, Customers, etc.</div>
                                    </div>
                                  </label>
                                  <label class="form-checkbox konicursor">
                                    <input class="form-checkbox-input konihide konicursor" type="checkbox">
                                    <div class="form-checkbox-label konicursor">
                                      <div class="form-checkbox-label-text">Delete or Void Saved Products</div>
                                    </div>
                                  </label>
                                  <label class="form-checkbox konicursor">
                                    <input class="form-checkbox-input konihide konicursor" type="checkbox">
                                    <div class="form-checkbox-label konicursor">
                                      <div class="form-checkbox-label-text">Edit Customer List</div>
                                    </div>
                                  </label>
                                  <label class="form-checkbox konicursor">
                                    <input class="form-checkbox-input konihide konicursor" type="checkbox">
                                    <div class="form-checkbox-label konicursor">
                                      <div class="form-checkbox-label-text">Issue Refunds</div>
                                    </div>
                                  </label>
                                  <label class="form-checkbox konicursor">
                                    <input class="form-checkbox-input konihide konicursor" type="checkbox">
                                    <div class="form-checkbox-label konicursor">
                                      <div class="form-checkbox-label-text">Manage Checkout</div>
                                    </div>
                                  </label>
                                  <label class="form-checkbox konicursor">
                                    <input class="form-checkbox-input konihide konicursor" type="checkbox">
                                    <div class="form-checkbox-label konicursor">
                                      <div class="form-checkbox-label-text">Maange Discoumt</div>
                                    </div>
                                  </label>
                                  <label class="form-checkbox konicursor">
                                    <input class="form-checkbox-input konihide konicursor" type="checkbox">
                                    <div class="form-checkbox-label konicursor">
                                      <div class="form-checkbox-label-text">Manage Modifiers</div>
                                    </div>
                                  </label>
                                  <label class="form-checkbox konicursor">
                                    <input class="form-checkbox-input konihide konicursor" type="checkbox">
                                    <div class="form-checkbox-label konicursor">
                                      <div class="form-checkbox-label-text">Manage Product Library</div>
                                    </div>
                                  </label>
                                </div>
                              </div>
                              <div class="form-field form-field-with-checkboxes">
                                <label class="form-field-label" for=""></label>
                                  <div class="form-field-content">
                                    <label class="form-checkbox-perm" for="meister">
                                      <input class="form-checkbox-input" id="meister" type="checkbox">
                                      <div class="form-checkbox-label">
                                        <div class="form-checkbox-label-text">
                                          <div class="form-permission-text super-strong">
                                            Meister - Access Management Website
                                          </div>
                                          <div class="form-helptext-desc">
                                            Allow your employees to access the Königeld backend and access selected permissions.
                                          </div>
                                        </div>
                                      </div>
                                    </label>
                                ...
                                <div class="form-field form-field-with-checkboxes konicursor">
                                  ...
                                  <div class="form-field-content">
                                    <label class="form-checkbox konicursor">
                                      <input class="form-checkbox-input konihide konicursor" type="checkbox">
                                      <div class="form-checkbox-label konicursor">
                                        <div class="form-checkbox-label-text">Manage Dashboard</div>
                                      </div>
                                    </label>
                                    <label class="form-checkbox konicursor">
                                      <input class="form-checkbox-input konihide konicursor" type="checkbox">
                                      <div class="form-checkbox-label konicursor">
                                        <div class="form-checkbox-label-text">Manage Reports</div>
                                      </div>
                                    </label>
                                    <label class="form-checkbox konicursor">
                                      <input class="form-checkbox-input konihide konicursor" type="checkbox">
                                      <div class="form-checkbox-label konicursor">
                                        <div class="form-checkbox-label-text">Manage Products</div>
                                      </div>
                                    </label>
                                    <label class="form-checkbox konicursor">
                                      <input class="form-checkbox-input konihide konicursor" type="checkbox">
                                      <div class="form-checkbox-label konicursor">
                                        <div class="form-checkbox-label-text">Manage Customers</div>
                                      </div>
                                    </label>
                                    <label class="form-checkbox konicursor">
                                      <input class="form-checkbox-input konihide konicursor" type="checkbox">
                                      <div class="form-checkbox-label konicursor">
                                        <div class="form-checkbox-label-text">Manage Employees</div>
                                      </div>
                                    </label>
                                    <label class="form-checkbox konicursor">
                                      <input class="form-checkbox-input konihide konicursor" type="checkbox">
                                      <div class="form-checkbox-label konicursor">
                                        <div class="form-checkbox-label-text">Manage Account Settings</div>
                                      </div>
                                    </label>
                                  </div>
                                </div>
