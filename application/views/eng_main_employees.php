      ...
      <div class="animated fadeIn">
        <main class="dashboard-layout">
          ...
          <div class="dashboard-header-layout-sidebar dashboard-header-layout-sidebar-nav">
            <a href="#" class="dashboard-header-sidebar-link dashboard-header-sidebar-link--active">Roles</a>
            <a href="#" class="dashboard-header-sidebar-link">Access</a>
          </div>
          <!--End Sidebar-->
          <!--Container-->
                    ...
                    <div class="filter-bar">
                      ...
                      <div class="filter-bar-actions">
                        <div class="filter-bar-item">
                          <button class="konibutton button-primary filter-bar-item" type="button" data-href="<?php echo base_url();?>employee_new">Add Employee</button>
                        </div>
                      </div>
                    </div>
                              ...
                              <thead>
                                <tr>
                                  <th colspan="1" rowspan="1" class="item-table-name super-strong">
                                    <div class="table-name-column arrow-up"><a class="customer-list-header" href="#">Employee Name</a></div>
                                  </th>
                                  <th colspan="1" rowspan="1" class="item-table-name super-strong">
                                  ...
                                  <th colspan="1" rowspan="1" class="item-table-name-2 super-strong">
                                    <div class="table-name-column type-align-right">E-mail</div>
                                  </th>
                                  <th colspan="1" rowspan="1" class="item-table-name-2 super-strong">
                                    <div class="table-name-column type-align-right">Role</div>
                                  </th>
                                  <th colspan="1" rowspan="1" class="item-table-name-2 super-strong">
